...
- [moduler-v5-and-dev-toolkit](#moduler-v5-and-dev-toolkit)
   ...
   - [API](#api)
      - [{@root}/DevToolkit/CommandLine/Colors.js](#rootdevtoolkitcommandlinecolorsjs)
      - [{@root}/DevToolkit/CommandLine/CommandLine.js](#rootdevtoolkitcommandlinecommandlinejs)
      - [{@root}/DevToolkit/CommandLine/Tools/Tools.js](#rootdevtoolkitcommandlinetoolstoolsjs)
      - [{@root}/DevToolkit/CommandLine/Tools/constructor.js](#rootdevtoolkitcommandlinetoolsconstructorjs)
      - [{@root}/DevToolkit/CommandLine/Tools/create.js](#rootdevtoolkitcommandlinetoolscreatejs)
      - [{@root}/DevToolkit/CommandLine/Tools/prototype.buildCss.js](#rootdevtoolkitcommandlinetoolsprototypebuildcssjs)
      - [{@root}/DevToolkit/CommandLine/Tools/prototype.buildDocs.js](#rootdevtoolkitcommandlinetoolsprototypebuilddocsjs)
      - [{@root}/DevToolkit/CommandLine/Tools/prototype.buildJs.js](#rootdevtoolkitcommandlinetoolsprototypebuildjsjs)
      - [{@root}/DevToolkit/CommandLine/Tools/prototype.loop.js](#rootdevtoolkitcommandlinetoolsprototypeloopjs)
      - [{@root}/DevToolkit/CommandLine/Tools/prototype.testJs.js](#rootdevtoolkitcommandlinetoolsprototypetestjsjs)
      - [{@root}/DevToolkit/CommandLine/Tools/prototype.toolkit.js](#rootdevtoolkitcommandlinetoolsprototypetoolkitjs)
      - [{@root}/DevToolkit/CommandLine/Tools/prototype.up.js](#rootdevtoolkitcommandlinetoolsprototypeupjs)
      - [{@root}/DevToolkit/CommandLine/baseProject.js](#rootdevtoolkitcommandlinebaseprojectjs)
      - [{@root}/DevToolkit/CommandLine/constructor.js](#rootdevtoolkitcommandlineconstructorjs)
      - [{@root}/DevToolkit/CommandLine/create.js](#rootdevtoolkitcommandlinecreatejs)
      - [{@root}/DevToolkit/CommandLine/printError.js](#rootdevtoolkitcommandlineprinterrorjs)
      - [{@root}/DevToolkit/CommandLine/prototype.createProject.js](#rootdevtoolkitcommandlineprototypecreateprojectjs)
      - [{@root}/DevToolkit/CommandLine/prototype.findProjectRoot.js](#rootdevtoolkitcommandlineprototypefindprojectrootjs)
      - [{@root}/DevToolkit/CommandLine/prototype.tool.js](#rootdevtoolkitcommandlineprototypetooljs)
      - [{@root}/DevToolkit/CommandLine/prototype.toolkit.js](#rootdevtoolkitcommandlineprototypetoolkitjs)
      - [{@root}/DevToolkit/CommandLine/prototype.tools.js](#rootdevtoolkitcommandlineprototypetoolsjs)
      - [{@root}/DevToolkit/Debug/Debug.js](#rootdevtoolkitdebugdebugjs)
      - [{@root}/DevToolkit/Debug/die.js](#rootdevtoolkitdebugdiejs)
      - [{@root}/DevToolkit/DevToolkit.entry.js](#rootdevtoolkitdevtoolkitentryjs)
      - [{@root}/DevToolkit/Documentator/Documentator.js](#rootdevtoolkitdocumentatordocumentatorjs)
      - [{@root}/DevToolkit/Documentator/constructor.js](#rootdevtoolkitdocumentatorconstructorjs)
      - [{@root}/DevToolkit/Documentator/prototype._extractJavadocCommentsFromString.js](#rootdevtoolkitdocumentatorprototype_extractjavadoccommentsfromstringjs)
      - [{@root}/DevToolkit/Documentator/prototype._findFiles.js](#rootdevtoolkitdocumentatorprototype_findfilesjs)
      - [{@root}/DevToolkit/Documentator/prototype.extractJavadocCommentsFromDirectory.js](#rootdevtoolkitdocumentatorprototypeextractjavadoccommentsfromdirectoryjs)
      - [{@root}/DevToolkit/Documentator/prototype.extractJavadocTextFromDirectory.js](#rootdevtoolkitdocumentatorprototypeextractjavadoctextfromdirectoryjs)
      - [{@root}/DevToolkit/Documentator/prototype.generateMarkdownTableOfContents.js](#rootdevtoolkitdocumentatorprototypegeneratemarkdowntableofcontentsjs)
      - [{@root}/DevToolkit/Documentator/prototype.toolkit.js](#rootdevtoolkitdocumentatorprototypetoolkitjs)
      - [{@root}/DevToolkit/Documentator/symbols.js](#rootdevtoolkitdocumentatorsymbolsjs)
      - [{@root}/DevToolkit/Events/Events.js](#rootdevtoolkiteventseventsjs)
      - [{@root}/DevToolkit/Events/constructor.js](#rootdevtoolkiteventsconstructorjs)
      - [{@root}/DevToolkit/Events/prototype.propagateOnTouch.js](#rootdevtoolkiteventsprototypepropagateontouchjs)
      - [{@root}/DevToolkit/Events/prototype.toolkit.js](#rootdevtoolkiteventsprototypetoolkitjs)
      - [{@root}/DevToolkit/Events/prototype.touch.js](#rootdevtoolkiteventsprototypetouchjs)
      - [{@root}/DevToolkit/FileSystem/FileSystem.js](#rootdevtoolkitfilesystemfilesystemjs)
      - [{@root}/DevToolkit/FileSystem/constructor.js](#rootdevtoolkitfilesystemconstructorjs)
      - [{@root}/DevToolkit/FileSystem/deleteDirectory.js](#rootdevtoolkitfilesystemdeletedirectoryjs)
      - [{@root}/DevToolkit/FileSystem/deleteFile.js](#rootdevtoolkitfilesystemdeletefilejs)
      - [{@root}/DevToolkit/FileSystem/emptyDirectory.js](#rootdevtoolkitfilesystememptydirectoryjs)
      - [{@root}/DevToolkit/FileSystem/exists.js](#rootdevtoolkitfilesystemexistsjs)
      - [{@root}/DevToolkit/FileSystem/existsDirectory.js](#rootdevtoolkitfilesystemexistsdirectoryjs)
      - [{@root}/DevToolkit/FileSystem/existsFile.js](#rootdevtoolkitfilesystemexistsfilejs)
      - [{@root}/DevToolkit/FileSystem/fromDirectoryToObject.js](#rootdevtoolkitfilesystemfromdirectorytoobjectjs)
      - [{@root}/DevToolkit/FileSystem/fromObjectToDirectory.js](#rootdevtoolkitfilesystemfromobjecttodirectoryjs)
      - [{@root}/DevToolkit/FileSystem/prototype.deleteDirectory.js](#rootdevtoolkitfilesystemprototypedeletedirectoryjs)
      - [{@root}/DevToolkit/FileSystem/prototype.deleteFile.js](#rootdevtoolkitfilesystemprototypedeletefilejs)
      - [{@root}/DevToolkit/FileSystem/prototype.emptyDirectory.js](#rootdevtoolkitfilesystemprototypeemptydirectoryjs)
      - [{@root}/DevToolkit/FileSystem/prototype.exists.js](#rootdevtoolkitfilesystemprototypeexistsjs)
      - [{@root}/DevToolkit/FileSystem/prototype.existsDirectory.js](#rootdevtoolkitfilesystemprototypeexistsdirectoryjs)
      - [{@root}/DevToolkit/FileSystem/prototype.existsFile.js](#rootdevtoolkitfilesystemprototypeexistsfilejs)
      - [{@root}/DevToolkit/FileSystem/prototype.fromDirectoryToObject.js](#rootdevtoolkitfilesystemprototypefromdirectorytoobjectjs)
      - [{@root}/DevToolkit/FileSystem/prototype.fromObjectToDirectory.js](#rootdevtoolkitfilesystemprototypefromobjecttodirectoryjs)
      - [{@root}/DevToolkit/FileSystem/prototype.readDirectory.js](#rootdevtoolkitfilesystemprototypereaddirectoryjs)
      - [{@root}/DevToolkit/FileSystem/prototype.readFile.js](#rootdevtoolkitfilesystemprototypereadfilejs)
      - [{@root}/DevToolkit/FileSystem/prototype.sizeOf.js](#rootdevtoolkitfilesystemprototypesizeofjs)
      - [{@root}/DevToolkit/FileSystem/prototype.toolkit.js](#rootdevtoolkitfilesystemprototypetoolkitjs)
      - [{@root}/DevToolkit/FileSystem/prototype.writeDirectory.js](#rootdevtoolkitfilesystemprototypewritedirectoryjs)
      - [{@root}/DevToolkit/FileSystem/prototype.writeFile.js](#rootdevtoolkitfilesystemprototypewritefilejs)
      - [{@root}/DevToolkit/FileSystem/readDirectory.js](#rootdevtoolkitfilesystemreaddirectoryjs)
      - [{@root}/DevToolkit/FileSystem/readFile.js](#rootdevtoolkitfilesystemreadfilejs)
      - [{@root}/DevToolkit/FileSystem/sizeOf.js](#rootdevtoolkitfilesystemsizeofjs)
      - [{@root}/DevToolkit/FileSystem/writeDirectory.js](#rootdevtoolkitfilesystemwritedirectoryjs)
      - [{@root}/DevToolkit/FileSystem/writeFile.js](#rootdevtoolkitfilesystemwritefilejs)
      - [{@root}/DevToolkit/FileWatcher/FileWatcher.js](#rootdevtoolkitfilewatcherfilewatcherjs)
      - [{@root}/DevToolkit/FileWatcher/Refrescador.js](#rootdevtoolkitfilewatcherrefrescadorjs)
      - [{@root}/DevToolkit/FileWatcher/start.js](#rootdevtoolkitfilewatcherstartjs)
      - [{@root}/DevToolkit/Reflection/Reflection.js](#rootdevtoolkitreflectionreflectionjs)
      - [{@root}/DevToolkit/Reflection/getDescriptionOf.js](#rootdevtoolkitreflectiongetdescriptionofjs)
      - [{@root}/DevToolkit/Reflection/printDescriptionOf.js](#rootdevtoolkitreflectionprintdescriptionofjs)
      - [{@root}/DevToolkit/Semaphore/Semaphore.js](#rootdevtoolkitsemaphoresemaphorejs)
      - [{@root}/DevToolkit/Semaphore/constructor.js](#rootdevtoolkitsemaphoreconstructorjs)
      - [{@root}/DevToolkit/Semaphore/prototype.acquire.js](#rootdevtoolkitsemaphoreprototypeacquirejs)
      - [{@root}/DevToolkit/Semaphore/prototype.destroy.js](#rootdevtoolkitsemaphoreprototypedestroyjs)
      - [{@root}/DevToolkit/Semaphore/prototype.filename.js](#rootdevtoolkitsemaphoreprototypefilenamejs)
      - [{@root}/DevToolkit/Semaphore/prototype.getFilepath.js](#rootdevtoolkitsemaphoreprototypegetfilepathjs)
      - [{@root}/DevToolkit/Semaphore/prototype.release.js](#rootdevtoolkitsemaphoreprototypereleasejs)
      - [{@root}/DevToolkit/Semaphore/prototype.setFilename.js](#rootdevtoolkitsemaphoreprototypesetfilenamejs)
      - [{@root}/DevToolkit/Semaphore/prototype.toolkit.js](#rootdevtoolkitsemaphoreprototypetoolkitjs)
      - [{@root}/DevToolkit/Templating/Templating.js](#rootdevtoolkittemplatingtemplatingjs)
      - [{@root}/DevToolkit/Templating/Tjs.js](#rootdevtoolkittemplatingtjsjs)
      - [{@root}/DevToolkit/Templating/constructor.js](#rootdevtoolkittemplatingconstructorjs)
      - [{@root}/DevToolkit/Testing/Asserter/Asserter.js](#rootdevtoolkittestingasserterasserterjs)
      - [{@root}/DevToolkit/Testing/Asserter/AssertionError.js](#rootdevtoolkittestingasserterassertionerrorjs)
      - [{@root}/DevToolkit/Testing/Testing.js](#rootdevtoolkittestingtestingjs)
      - [{@root}/DevToolkit/Testing/constructor.js](#rootdevtoolkittestingconstructorjs)
      - [{@root}/DevToolkit/Time/Time.js](#rootdevtoolkittimetimejs)
      - [{@root}/DevToolkit/Tracer/Tracer.js](#rootdevtoolkittracertracerjs)
      - [{@root}/DevToolkit/Tracer/createTracer.js](#rootdevtoolkittracercreatetracerjs)
      - [{@root}/DevToolkit/Tracer/inspectToString.js](#rootdevtoolkittracerinspecttostringjs)
      - [{@root}/DevToolkit/Tracer/stringify.js](#rootdevtoolkittracerstringifyjs)
      - [{@root}/DevToolkit/Utils/Utils.js](#rootdevtoolkitutilsutilsjs)
      - [{@root}/DevToolkit/constructor.js](#rootdevtoolkitconstructorjs)
      - [{@root}/DevToolkit/create.js](#rootdevtoolkitcreatejs)
      - [{@root}/DevToolkit/prototype.assert.js](#rootdevtoolkitprototypeassertjs)
      - [{@root}/DevToolkit/prototype.basedir.js](#rootdevtoolkitprototypebasedirjs)
      - [{@root}/DevToolkit/prototype.cli.js](#rootdevtoolkitprototypeclijs)
      - [{@root}/DevToolkit/prototype.documentator.js](#rootdevtoolkitprototypedocumentatorjs)
      - [{@root}/DevToolkit/prototype.events.js](#rootdevtoolkitprototypeeventsjs)
      - [{@root}/DevToolkit/prototype.fileSystem.js](#rootdevtoolkitprototypefilesystemjs)
      - [{@root}/DevToolkit/prototype.fullpathOf.js](#rootdevtoolkitprototypefullpathofjs)
      - [{@root}/DevToolkit/prototype.moduler.js](#rootdevtoolkitprototypemodulerjs)
      - [{@root}/DevToolkit/prototype.semaphore.js](#rootdevtoolkitprototypesemaphorejs)
      - [{@root}/DevToolkit/prototype.subpathOf.js](#rootdevtoolkitprototypesubpathofjs)
      - [{@root}/DevToolkit/prototype.templating.js](#rootdevtoolkitprototypetemplatingjs)
      - [{@root}/DevToolkit/prototype.testing.js](#rootdevtoolkitprototypetestingjs)
      - [{@root}/ModulerV5/CssModuler/CssModuler.js](#rootmodulerv5cssmodulercssmodulerjs)
      - [{@root}/ModulerV5/CssModuler/constructor.js](#rootmodulerv5cssmodulerconstructorjs)
      - [{@root}/ModulerV5/CssModuler/create.js](#rootmodulerv5cssmodulercreatejs)
      - [{@root}/ModulerV5/CssModuler/fakeCssStyleSheet.js](#rootmodulerv5cssmodulerfakecssstylesheetjs)
      - [{@root}/ModulerV5/CssModuler/prototype._exportSource.js](#rootmodulerv5cssmodulerprototype_exportsourcejs)
      - [{@root}/ModulerV5/CssModuler/prototype._generateSource.js](#rootmodulerv5cssmodulerprototype_generatesourcejs)
      - [{@root}/ModulerV5/CssModuler/prototype._sortSheets.js](#rootmodulerv5cssmodulerprototype_sortsheetsjs)
      - [{@root}/ModulerV5/CssModuler/prototype._synchronizeSource.js](#rootmodulerv5cssmodulerprototype_synchronizesourcejs)
      - [{@root}/ModulerV5/CssModuler/prototype.add.js](#rootmodulerv5cssmodulerprototypeaddjs)
      - [{@root}/ModulerV5/CssModuler/prototype.assert.js](#rootmodulerv5cssmodulerprototypeassertjs)
      - [{@root}/ModulerV5/CssModuler/prototype.entry.js](#rootmodulerv5cssmodulerprototypeentryjs)
      - [{@root}/ModulerV5/CssModuler/prototype.extractCompilation.js](#rootmodulerv5cssmodulerprototypeextractcompilationjs)
      - [{@root}/ModulerV5/CssModuler/prototype.remove.js](#rootmodulerv5cssmodulerprototyperemovejs)
      - [{@root}/ModulerV5/CssModuler/prototype.sheets.js](#rootmodulerv5cssmodulerprototypesheetsjs)
      - [{@root}/ModulerV5/CssModuler/prototype.synchronize.js](#rootmodulerv5cssmodulerprototypesynchronizejs)
      - [{@root}/ModulerV5/CssModuler/symbols.js](#rootmodulerv5cssmodulersymbolsjs)
      - [{@root}/ModulerV5/Dictionary.js](#rootmodulerv5dictionaryjs)
      - [{@root}/ModulerV5/ModulerV5.entry.js](#rootmodulerv5modulerv5entryjs)
      - [{@root}/ModulerV5/Promise.fromObject.js](#rootmodulerv5promisefromobjectjs)
      - [{@root}/ModulerV5/constructor.js](#rootmodulerv5constructorjs)
      - [{@root}/ModulerV5/create.js](#rootmodulerv5createjs)
      - [{@root}/ModulerV5/default.js](#rootmodulerv5defaultjs)
      - [{@root}/ModulerV5/inspectToString.js](#rootmodulerv5inspecttostringjs)
      - [{@root}/ModulerV5/prototype._callModuleFactory.js](#rootmodulerv5prototype_callmodulefactoryjs)
      - [{@root}/ModulerV5/prototype.assert.js](#rootmodulerv5prototypeassertjs)
      - [{@root}/ModulerV5/prototype.basedir.js](#rootmodulerv5prototypebasedirjs)
      - [{@root}/ModulerV5/prototype.cloneForDirectory.js](#rootmodulerv5prototypeclonefordirectoryjs)
      - [{@root}/ModulerV5/prototype.cloneForFile.js](#rootmodulerv5prototypecloneforfilejs)
      - [{@root}/ModulerV5/prototype.css.js](#rootmodulerv5prototypecssjs)
      - [{@root}/ModulerV5/prototype.define.js](#rootmodulerv5prototypedefinejs)
      - [{@root}/ModulerV5/prototype.definitions.js](#rootmodulerv5prototypedefinitionsjs)
      - [{@root}/ModulerV5/prototype.fullpathOf.js](#rootmodulerv5prototypefullpathofjs)
      - [{@root}/ModulerV5/prototype.importModule.js](#rootmodulerv5prototypeimportmodulejs)
      - [{@root}/ModulerV5/prototype.isBrowser.js](#rootmodulerv5prototypeisbrowserjs)
      - [{@root}/ModulerV5/prototype.isTracing.js](#rootmodulerv5prototypeistracingjs)
      - [{@root}/ModulerV5/prototype.knows.js](#rootmodulerv5prototypeknowsjs)
      - [{@root}/ModulerV5/prototype.mean.js](#rootmodulerv5prototypemeanjs)
      - [{@root}/ModulerV5/prototype.normalizationOf.js](#rootmodulerv5prototypenormalizationofjs)
      - [{@root}/ModulerV5/prototype.readFile.js](#rootmodulerv5prototypereadfilejs)
      - [{@root}/ModulerV5/prototype.readPath.js](#rootmodulerv5prototypereadpathjs)
      - [{@root}/ModulerV5/prototype.readUrl.js](#rootmodulerv5prototypereadurljs)
      - [{@root}/ModulerV5/prototype.relpathOf.js](#rootmodulerv5prototyperelpathofjs)
      - [{@root}/ModulerV5/prototype.rootdir.js](#rootmodulerv5prototyperootdirjs)
      - [{@root}/ModulerV5/prototype.trace.js](#rootmodulerv5prototypetracejs)
      - [{@root}/ModulerV5/stringify.js](#rootmodulerv5stringifyjs)
   - [Reflexión](#reflexion)
...
- **@type:** class method
- **@parameter:**
   - dir:String|null = this.toolkit.basedir - Directorio del cual se quieren extraer los comentarios javadoc. En caso de null se usa el de por defecto normal, this.toolkit.basedir.
   - options:Object - Opciones.
   - - options.header:String|undefined - Texto de cabecera.
   - - options.tableOfContents:true|false|undefined - Genera la tabla de contenidos en `true`.
   - - options.footer:String|undefined - Texto de pie de documento.
...
### {@root}/DevToolkit/Documentator/prototype.generateMarkdownTableOfContents.js
...
- **@type:** class method
- **@parameter:**
   - md:String - Código en markdown
   - autoinjectInto:String|false|undefined="{{ Table Of Contents }} - String donde se tiene que autoinyectar la tabla en el primer parámetro md:String.
