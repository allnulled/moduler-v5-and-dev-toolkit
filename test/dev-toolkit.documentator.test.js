...
- **@tipo:** Class
- **@descripción:** Es una clase de ejemplo
- **@sección:** Tests/Documentación/Ejemplo/1/Example


----

- **@tipo:** Database
- **@descripción:** Es una clase que finge ser una base de datos
- **@sección:** Tests/Documentación/Ejemplo/1/Example/Database
